...
def main(yml_fpath):
    ...
    import_dataset(yml_conf["label_extension", yml_conf["images_patt"], yml_conf["final_label_dict"], yml_conf["dataset_name"])

    #results = comp_viz(dataset)
    results = comp_viz(dataset, yml_conf["dataset_name"], yml_conf["label_paths"])
