...
"data" : {
 ...
 "scale_data" : True,
 "pixel_padding" : 2,
 "number_channels": 445 , #ignore for now - dynamically read
 "fill_value" : -99999.0,
 "valid_min" : -9000.0,
 "valid_max" : 100000000,
 "subset_count" : 1,
 ...
 "reader_type" : "emit_l2",
 "reader_kwargs" : {
  "mask_oceans" : False, #Removes Oceans from consideration
 },
 "chan_dim" : 2,
 "delete_chans" : [],
 "transform_default" : {
...
"output" : {
 "out_dir" : "/home/nlahaye/DBN_OIL_PALM_MAPS/",
...
"encoder": {
 "tiled": False,
 "tune_scaler" : False,
 "subset_training" : 2500000, #2000000,
