...
out_dat_fname = "/data/nlahaye/remoteSensing/PV_Mapping/Full_Area/pv_polygons"

annotation_fname = "/data/nlahaye/remoteSensing/PV_Mapping/Full_Area/pv_polygons.tif"
