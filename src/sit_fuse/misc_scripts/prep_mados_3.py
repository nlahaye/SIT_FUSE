...
ppth = "/data/nlahaye/output/Learnergy/MADOS_IJEPA_TEST_3_Tile/"
...
for lne in lnes:
    ...
    #print("[")
    #for i in range(len(ten_ms)):
    pth = ppth + str(mtch.group(1)) + "_L2R_rhorc_492_" + str(mtch.group(2)) + ".mados_jepa_v5.indices.zarr"
    #fglob = glob.glob(pth)
    fname_tmp = pth #fglob[0]
    print("\"" +fname_tmp + "\",")
    #print("],")
print("]")
