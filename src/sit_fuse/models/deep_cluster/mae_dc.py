...
from sit_fuse.models.deep_cluster.mae_segmentor import MAESegmentor
...
class MAE_DC(pl.LightningModule):
    ...
    def __init__(self, pretrained_model_path, num_classes, lr=1e-3, weight_decay=0, drop_path=0.1, number_heads=1):
        ...
        #define model layers
        self.pretrained_model = MAE_PL.load_from_checkpoint(pretrained_model_path)
        self.pretrained_model.vit.layer_dropout = 0.0
  
        feature_maps = [1,3,5,7]
        self.segmentor = MAESegmentor(num_classes, feature_maps, self.pretrained_model.vit)
        ...
        #self.mlp_head = MAE_Seg(num_classes)
