...
'''
class Late_Fusion_DBN_PL(pl.LightningModule):
    def __init__(
            self,
            model,
            save_dir,
        ...
        super().__init__()
        self.save_hyperparameters(ignore=['model', 'previous_layers', 'encoders'])
    ...
    def on_validation_epoch_end(self):
        torch.save(self.model.state_dict(), os.path.join(self.save_dir, "late_fusion_dbn.ckpt"))
