...
data_train = np.load("/data/nlahaye/output/Learnergy/DBN_eMAS_FULL_STRAT_Segformer_DINO_full_channel/train_data.npy")
...
torch.save(model.state_dict(), '/data/nlahaye/output/Learnergy/DBN_eMAS_FULL_STRAT_Segformer_DINO_full_channel/pretrained-vit_RGB.pt')
