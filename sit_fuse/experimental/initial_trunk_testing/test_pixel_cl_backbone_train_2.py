...
resnet50_3_channel = multichannel_resnet.Resnet_multichannel(pretrained=False, encoder_depth=152, num_in_channels=34).cuda()
print("New input channels : ", resnet50_3_channel.conv1.in_channels)

summary(resnet50_3_channel, (34, 64, 64))
...
data_train = np.load("/data/nlahaye/output/Learnergy/DBN_eMAS_FULL_STRAT_RESNET_BACKBONE/train_data.npy")
...
torch.save(resnet50_3_channel.state_dict(), "/data/nlahaye/output/Learnergy/DBN_eMAS_FULL_STRAT_RESNET_BACKBONE/segmentation_backbone_resnet50_state_dict_no_pretrain.pt")
