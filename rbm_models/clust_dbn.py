    ...
    def fit(
        ...
        for e in range(epochs):
            ...
            for x_batch, _ in tqdm(batches):
                ...
                x2 = torch.from_numpy(gaussian_filter1d(x_batch, 3))
                loss = 0
                dt = torch.float16
                if self.device == "cpu":
                    dt = torch.bfloat16 
...
class MultiPrototypes(nn.Module):
    ...
    def __init__(self, output_dim, n_classes, nmb_heads):
        ...
        for i in range(nmb_heads):
            ...
            #for j in range(0,3):
            #self.add_module("prototypes" + str(i) + "_0", nn.Linear(output_dim, output_dim))
